...
import com.kuaishouaxiu.www.kuaishouaxiu.R;
...
//		arrowImage = AbFileUtil.getBitmapFromSrc("image/ic_jiantou_xia.png");
//		arrowImageView.setImageBitmap(arrowImage);
        arrowImageView.setImageResource(R.drawable.pull_jiantou);
...
//		headerProgressBar.setIndeterminateDrawable(getResources().getDrawable(R.anim.loading));
